                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="largeModalLabel">Add Doctor and Practice</h5>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form >
                                            ...
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Name of Company</label>
                                            ...
                                            <div class="form-group has-success">
                                                <label for="cc-name" class="control-label mb-1">Name Of Doctor</label>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">VAT</label>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Passwowrd</label>
